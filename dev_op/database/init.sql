-- FrostByte Logistics Database Initialization Script
-- Creates tables for warehouses, routes, products, and commitments

-- Table: Locations (Warehouses)
CREATE TABLE IF NOT EXISTS Locations (
    location_id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    location_type VARCHAR(50) NOT NULL, -- 'warehouse', 'hospital', 'retailer', etc.
...
CREATE TABLE IF NOT EXISTS Products (
    ...
    name VARCHAR(255) NOT NULL,
    temperature_requirement VARCHAR(50) NOT NULL, -- 'frozen', 'refrigerated', 'cold', 'ambient'
...
CREATE TABLE IF NOT EXISTS Routes (
    ...
    temperature_capability VARCHAR(50) NOT NULL, -- 'frozen', 'refrigerated', 'cold', 'ambient'
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS Commitments (
    ...
    status VARCHAR(20) DEFAULT 'pending', -- 'pending', 'validated', 'rejected', 'fulfilled'
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (from_location_id) REFERENCES Locations(location_id) ON DELETE CASCADE,
    FOREIGN KEY (to_location_id) REFERENCES Locations(location_id) ON DELETE CASCADE,
